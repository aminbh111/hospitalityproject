...
export class PlaylistComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.playlistService
      ...
      .subscribe({
        next: (res: HttpResponse<IPlaylist[]>) => {
  ...
  trackId(_index: number, item: IPlaylist): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPlaylist[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
