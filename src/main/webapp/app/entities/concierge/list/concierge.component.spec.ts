...
describe('Concierge Management Component', () => {
  let comp: ConciergeComponent;
  let fixture: ComponentFixture<ConciergeComponent>;
  let service: ConciergeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'concierge', component: ConciergeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ConciergeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.concierges?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
