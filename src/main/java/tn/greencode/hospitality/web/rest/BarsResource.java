...
public class BarsResource {
    ...
    public BarsResource(BarsRepository barsRepository) {
    ...
    public ResponseEntity<Bars> createBars(@RequestBody Bars bars) throws URISyntaxException {
        ...
        Bars result = barsRepository.save(bars);
    ...
    public ResponseEntity<Bars> partialUpdateBars(@PathVariable(value = "id", required = false) final Long id, @RequestBody Bars bars)
        ...
        Optional<Bars> result = barsRepository
            .findById(bars.getId())
            .map(existingBars -> {
     ...
     */
    @GetMapping("/bars")
    public ResponseEntity<List<Bars>> getAllBars(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Bars");
        Page<Bars> page = barsRepository.findAll(pageable);
    ...
    public ResponseEntity<Bars> getBars(@PathVariable Long id) {
        ...
        Optional<Bars> bars = barsRepository.findById(id);
